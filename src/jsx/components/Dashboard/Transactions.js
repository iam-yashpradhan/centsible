...
//Images 
import avat11 from './../../../images/avatar/11.png';
import avat17 from './../../../images/avatar/17.png';
...
import avat27 from './../../../images/avatar/27.png';
import avat28 from './../../../images/avatar/28.png';
import avat29 from './../../../images/avatar/29.png';

const Transactions = () => {
	const [sendDownload, setSendDownload] = useState(false);
	...
	return(
		<Fragment>
			<div class= "page-titles form-head d-flex flex-wrap justify-content-between align-items-center mb-4">
				<h2 className="text-black font-w600 mb-0 me-auto mb-2 pr-3">Transactions History</h2>
				<Dropdown className="custom-dropdown me-3 mb-2" >
					<Dropdown.Toggle className="btn bg-white btn-rounded i-false" variant='' >
						<svg className="me-2" width="53" height="35" viewBox="0 0 53 35" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<Link to={"#"} className="btn btn-primary btn-rounded me-3  mb-2" onClick={() => setSendDownload(true)}>
				...
				{/*  Modal  */}
				<Modal className="modal fade"  show={sendDownload}>
					<div className=" modal-dialog-centered" >
						<div className="modal-content">
							<div className="modal-header">
								<h5 className="modal-title">Modal title</h5>
								<button type="button" className="close" onClick={() => setSendDownload(false)}><span>&times;</span>
								</button>
							</div>
							...
							<div className="modal-footer">
								<button type="button" className="btn btn-danger light" onClick={() => setSendDownload(false)}>Close</button>
					...
					<div className="table-responsive table-hover fs-14 card-table dataTables_wrapper" id="transactions-data">
						<table	className='table display mb-4 dataTablesCard  dataTable no-footer' id='example5'>
							...
							<tbody>
								<tr role='row' className='odd'>
									...
									<td><Link to={"#"} className="btn btn-outline-warning btn-rounded">Pending</Link></td>									
									<td><DropdownBlog /></td>
								</tr>
								<tr role='row' className='even'	>
									...
									<td><Link to={"#"} className="btn btn-outline-dark btn-rounded">Canceled</Link></td>								
									<td><DropdownBlog /></td>
								</tr>
								<tr role='row' className='odd'>
									<td className='application_sorting_1'>
									...
									<td><Link to={"#"} className="btn btn-outline-success btn-rounded">Completed</Link></td>							
									<td><DropdownBlog /></td>
								</tr>
								<tr role='row' className='even'>
									<td className='application_sorting_1'>
						...
						<div className='d-sm-flex text-center justify-content-between align-items-center'>
							...
							<div className='dataTables_paginate paging_simple_numbers' id='example5_paginate'>
								<Link to='/transactions' className='paginate_button previous disabled' onClick={() => activePag.current > 0 && onClick(activePag.current - 1)}>
									Previous
								</Link>
								<span>
									{paggination.map((number, i) => (
										<Link key={i} to='/transactions' className={`paginate_button  ${ activePag.current === i ? 'current' : '' } `} onClick={() => onClick(i)}>
											{number}
										</Link>
									))}
								</span>
								<Link to='/transactions' className='paginate_button next' onClick={() => activePag.current + 1 < paggination.length && onClick(activePag.current + 1)}>
									Next
								</Link>
							</div>
						</div>	
